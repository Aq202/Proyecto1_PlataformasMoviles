...
interface UserRepository {
    ...
    suspend fun editProfile(firstName: String, lastName: String, birthDate: String, user: String, email: String, password: String, profilePicPath: String): Resource<Boolean>
