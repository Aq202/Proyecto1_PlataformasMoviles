...
import com.example.proyecto_final_apps.databinding.FragmentEditPendingPaymentBinding
import com.example.proyecto_final_apps.helpers.addChip
import com.google.android.material.chip.Chip
import com.google.android.material.chip.ChipGroup
import com.google.android.material.datepicker.MaterialDatePicker

class EditPendingPaymentFragment : Fragment() {
    private lateinit var binding: FragmentEditPendingPaymentBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentEditPendingPaymentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setDropLists() {
        ...
        binding.autoCompleteViewEditPendingPaymentFragmentOperationType.setAdapter(adapterOperation)
    }
    ...
    private fun generateChipGroup() {
        ...
        categories.forEach{ cathegory ->
            ...
            binding.chipGroupEditPendingPaymentFragmentCathegories.addChip(requireContext(), cathegory, backgroundCSL, strokeCSL)
        }
    }
    ...
    private fun setListeners() {
        val chipGroup = binding.chipGroupEditPendingPaymentFragmentCathegories
        ...
        binding.autoCompleteViewEditPendingPaymentFragmentOperationType.setOnItemClickListener { adapterView, view, i, l ->
        ...
        binding.datePickerEditPendingPaymentFragmentNotificationDate.setOnClickListener {
            val datePicker =
            ...
            datePicker.addOnPositiveButtonClickListener {
                binding.datePickerEditPendingPaymentFragmentNotificationDate.setText(datePicker.headerText)
            }

            datePicker.show(requireActivity().supportFragmentManager, "DatePicker")
        }
        binding.buttonEditPendingPaymentFragmentAdd.setOnClickListener{
            requireView().findNavController().navigate(R.id.action_newPendingPaymentFragment_to_editPendingPaymentFragment)
        }
    }
}