...
interface OperationRepository {
    ...
    suspend fun createOperation(title: String, accountLocalId: Int, amount: Double, active: Boolean, description: String?, category: Int, favorite: Boolean, date: String, imgUrl:String? = null, updateAccountTotal:Boolean = true):Resource<OperationModel>
